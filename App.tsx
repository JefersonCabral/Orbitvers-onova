...
export default function App() {
  ...
  const WHATSAPP_URL = 'https://wa.me/554497357216';
  ...
  return (
    <div className="min-h-screen bg-[#0A0E1A] text-white selection:bg-indigo-500 selection:text-white overflow-x-hidden">
              ...
              <div className="px-4 pt-3 pb-1 space-y-1">
                ...
                <div className="pt-3 border-t border-white/[0.06] mt-2 flex flex-col gap-2.5 px-1">
                  ...
                  <a
                    href="#precos"
                    onClick={(e) => {
                      handleAnchorClick(e, '#precos');
                      setIsMobileMenuOpen(false);
                    }}
                    className="w-full inline-flex justify-center rounded-full bg-white text-neutral-900 py-3 text-sm font-semibold hover:-translate-y-0.5 transition-all duration-200"
                  >
                    Começar Agora
                  </a>
                </div>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-40 flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 hover:-translate-y-1 group"
        aria-label="Falar com suporte no WhatsApp"
        title="Suporte WhatsApp"
      >
        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="white" className="group-hover:scale-110 transition-transform duration-300">
